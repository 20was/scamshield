...
interface AccountCheckupProps {
  items: SecurityCheckItem[]
  completedItems: string[]
  onToggleItem: (itemId: string) => void
}

export function AccountCheckup({ items, completedItems, onToggleItem }: AccountCheckupProps) {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Account Security Check</CardTitle>
        <CardDescription>Verify your online accounts are properly secured</CardDescription>
      </CardHeader>
