...
export function PrivacyCheckup({ items, completedItems, onToggleItem }: PrivacyCheckupProps) {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Privacy Protection Check</CardTitle>
        <CardDescription>Ensure your personal information is protected online</CardDescription>
      </CardHeader>
